...
int main()
{
    ...
    NORVES_CHECK_EQ(positive, static_cast<std::size_t>(59));
    NORVES_CHECK_EQ(envelopeRejectable, static_cast<std::size_t>(14));
    NORVES_CHECK_EQ(payloadOnly, static_cast<std::size_t>(47));
    NORVES_CHECK_EQ(positive + envelopeRejectable + payloadOnly, static_cast<std::size_t>(120));
