#ifndef NORVES_BRIDGE_DTO_METHODS_HPP
#define NORVES_BRIDGE_DTO_METHODS_HPP
...
struct HelloParams {
    ...
    [[nodiscard]] bool operator==(const HelloParams& other) const {
        return role == other.role && clientName == other.clientName &&
               clientVersion == other.clientVersion && protocolVersions == other.protocolVersions;
    }
...
struct StatusSnapshot {
    ...
    [[nodiscard]] bool operator!=(const StatusSnapshot& other) const { return !(*this == other); }
...
#endif  // NORVES_BRIDGE_DTO_METHODS_HPP
