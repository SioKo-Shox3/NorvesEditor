#ifndef NORVES_BRIDGE_DTO_EVENTS_HPP
#define NORVES_BRIDGE_DTO_EVENTS_HPP
...
struct LogMessageEvent {
    ...
    [[nodiscard]] bool operator!=(const LogMessageEvent& other) const { return !(*this == other); }
...
#endif  // NORVES_BRIDGE_DTO_EVENTS_HPP
