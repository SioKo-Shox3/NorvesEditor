...
### 関連実ファイル（絶対パス）
- `C:\Users\<user>\Documents\NorvesEditor\apps\editor\package.json`（dockview-react 追加）
- `C:\Users\<user>\Documents\NorvesEditor\apps\editor\src\components\AppLayout.tsx`（DockviewReact へ全面置換、GameViewPanel への 14 props 注入 :58-73）
- `C:\Users\<user>\Documents\NorvesEditor\apps\editor\src\state\store.ts`
- `C:\Users\<user>\Documents\NorvesEditor\apps\editor\src\hooks\useBridge.ts`（購読 :108-198）
- `C:\Users\<user>\Documents\NorvesEditor\apps\editor\src\hooks\useBridge.lifecycle.test.tsx`（EXPECTED_SUBSCRIPTION_COUNT :42 / 参照 :81,:82）
- `C:\Users\<user>\Documents\NorvesEditor\apps\editor\src\hooks\useBridge.test.ts`（toHaveLength(2) :131、別テスト）
- `C:\Users\<user>\Documents\NorvesEditor\apps\editor\src-tauri\src\bridge_state.rs`（PROTOCOL_VERSION:58 / build_request:141 / HelloParams:292-301 / インラインテスト:633）
- `C:\Users\<user>\Documents\NorvesEditor\apps\editor\src-tauri\src\protocol_names.rs`
- `C:\Users\<user>\Documents\NorvesEditor\apps\editor\src-tauri\src\events_map.rs`（:14-24）
- `C:\Users\<user>\Documents\NorvesEditor\apps\editor\src-tauri\tests\process_e2e.rs`（version :164,:219 / NORVES_ENGINE_PATH :469）
- `C:\Users\<user>\Documents\NorvesEditor\apps\editor\src-tauri\tauri.conf.json`（CSP:23、変更不要）
- `C:\Users\<user>\Documents\NorvesEditor\bridge\cpp\engine-sdk\include\norves\bridge\version.hpp`（SupportedProtocolVersions:22-24）
- `C:\Users\<user>\Documents\NorvesEditor\bridge\cpp\engine-sdk\src\server.cpp`（EnvelopeVersion:50 / NegotiateVersion:118-131、handleFrame は version 非検証）
- `C:\Users\<user>\Documents\NorvesEditor\bridge\cpp\examples\mock-engine\mock_adapter.hpp`（capability version :73 は bump 対象外）
- `C:\Users\<user>\Documents\NorvesEditor\bridge\cpp\examples\mock-engine\main.cpp`（:257-287）
- `C:\Users\<user>\Documents\NorvesEditor\bridge\cpp\engine-sdk\tests\ws_test_server.cpp`（FakeAdapter）
- `C:\Users\<user>\Documents\NorvesEditor\bridge\cpp\engine-sdk\tests\fixtures_roundtrip_test.cpp`（カウント 192-195）
- `C:\Users\<user>\Documents\NorvesEditor\bridge\cpp\engine-sdk\tests\smoke_test.cpp`（:64 = 実変更対象）
- `C:\Users\<user>\Documents\NorvesEditor\bridge\cpp\engine-sdk\tests\dispatch_test.cpp`（:219 = 実変更対象 / :125,:347 = 変更しない inbound）
- `C:\Users\<user>\Documents\NorvesEditor\bridge\cpp\engine-sdk\tests\loopback_roundtrip_test.cpp`（:154,:260,:371,:379,:434,:440,:446 = 変更しない inbound/negotiate）
- `C:\Users\<user>\Documents\NorvesEditor\bridge\crates\norves-bridge-core\tests\fixtures_roundtrip.rs`（カウント 124-135 / 175 / 195 / 221）
...
- `C:\Users\<user>\Documents\NorvesEditor\bridge\conformance\runners\alpha_method_sequence.json`
- `C:\Users\<user>\Documents\NorvesEditor\bridge\spec\fixtures\methods\bridge.hello\positive\`（NEW: request-valid-v02.json / response-valid-v02.json、response-version-unsupported.json 値更新）
- `C:\Users\<user>\Documents\NorvesEditor\bridge\spec\schema\events\`（NEW: scene.treeChanged / object.changed）
- `C:\Users\<user>\Documents\NorvesEditor\bridge\spec\schema\methods\`（NEW: viewport.getThumbnail）
- `C:\Users\<user>\Documents\NorvesEditor\bridge\spec\docs\protocol-overview.md` / `error-model.md` / `capabilities.md` / `message-payloads.md`
- `C:\Users\<user>\Documents\NorvesEditor\scripts\check-protocol-names.mjs`（命名正規表現 :56）
- `C:\Users\<user>\Documents\NorvesEditor\docs\memory-buffer-policy.md`（Phase 7b 前提・数値追記）
- `C:\Users\<user>\Documents\NorvesEditor\docs\viewport-strategy.md`
