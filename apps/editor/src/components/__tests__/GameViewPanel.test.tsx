...
const mockActions = {
  ...
  reloadAssetRuntime: vi.fn<BridgeActions['reloadAssetRuntime']>().mockResolvedValue(undefined),
  dismissAssetReloadError: vi.fn<BridgeActions['dismissAssetReloadError']>(),
